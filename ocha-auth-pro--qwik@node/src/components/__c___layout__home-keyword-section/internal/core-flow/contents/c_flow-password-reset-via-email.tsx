...
export const FlowPasswordResetViaEmail = component$(({ code }: { code: ModalKeywordCode }) => {
  const classes = `
        flex-column justify-start
        p-10
        ${code === modalKeywordCode.coreFlow.PASSWORD_RESET_VIA_EMAIL ? `flex visible opacity-1` : `none hidden opacity-0`}
        `
  return (
    <div class={classes} style={{ paddingTop: "45px", paddingBottom: "45px" }}>
      <h1 class={`font-size-18 color-theme-sub p-tb-5`}>Password Reset via Email</h1>
      ...
      <section class={`p-tb-5`}>
        ...
        <div class={`relative`}>
          ...
          <div class={`flex flex-column p-tb-10 gap-10 items-center`} style={{ flexWrap: "wrap" }}>
            <DiagramStepC step={`User Input (Email)`} />
            <DiagramArrow />
            <DiagramStepC step={`Validate Email Format`} />
            <DiagramArrow />
            <DiagramStepS step={`Send Request 1`} />
            <DiagramArrow />
            <DiagramStepB step={`Validate Payload`} />
            <DiagramArrow />
            <DiagramStepB step={`Exist User Check`} />
            <DiagramArrow />
            ...
            <DiagramArrow />
            <DiagramStepC step={`User Input (New Password)`} />
            <DiagramArrow />
            <DiagramStepC step={`Validate Password Format`} />
            <DiagramArrow />
            <DiagramStepS step={`Send Request 3`} />
            <DiagramArrow />
            <DiagramStepB step={`Verify Token Again`} />
            <DiagramArrow />
            <DiagramStepB step={`Store Hashed Password`} />
            <DiagramArrow />
            <DiagramStepB step={`Send Reply`} />
            <DiagramArrow />
            <DiagramStepS step={`Server Redirect`} />
